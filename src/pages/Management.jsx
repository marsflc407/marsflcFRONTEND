  ...
  return (
    <>
      <PageHero
        ...
        intro="Leadership at MARS FLC connects principled decision-making with disciplined legal and financial consultancy."
      />
      ...
      <section className="border-b border-[#EFF6FF] py-20 md:py-24">
        <div className="container-custom mx-auto max-w-[1400px] px-4">
          <SectionHeader
            ...
            title="Three commitments guide every decision"
            intro="Integrity, accountability, and client trust guide MARS FLC's professional service."
          />
      ...
      <section className="border-b border-[#EFF6FF] bg-[#123B63] py-20 text-white md:py-24">
        <div className="container-custom mx-auto grid max-w-[1400px] gap-12 px-4 lg:grid-cols-12 lg:items-center">
          <div className="lg:col-span-5">
            <SectionLabel>Strategic Focus</SectionLabel>
          ...
          <div className="lg:col-span-7">
            ...
            <p className="mt-8 max-w-2xl text-lg leading-relaxed text-white/65">
              Management invests in the systems, people, and feedback loops that
              make recovery work visible, responsible, and repeatable for every
              client.
            </p>
          </div>
        </div>
      ...
      <section className="border-b border-[#EFF6FF] py-20 md:py-24">
        <div className="container-custom mx-auto max-w-[1400px] px-4">
          <div className="grid gap-12 lg:grid-cols-12 lg:items-end">
            <div className="lg:col-span-7">
              <SectionLabel>Service Philosophy</SectionLabel>
            ...
            <p className="text-lg leading-relaxed text-[#123B63]/70 lg:col-span-5">
              Every management decision is measured against the client outcome:
              certainty, responsiveness, and a partner that stays accountable
              through completion.
            </p>
          </div>
        </div>
      ...
      <section className="py-20 md:py-24">
        <div className="container-custom mx-auto max-w-[1400px] px-4">
          <SectionHeader
            ...
            title="Leadership with field awareness"
            intro="MARS FLC's team structure supports accountable delivery across its service areas."
          />
