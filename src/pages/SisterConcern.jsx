  ...
  return (
    <>
      <PageHero
        ...
        title={COMPANY.name}
        intro="MARS FLC is a Bangladeshi consultancy firm specializing in legal and financial services."
      />
        ...
        <div className="container-custom mx-auto grid max-w-[1400px] gap-12 px-4 lg:grid-cols-12 lg:items-center">
          <div className="lg:col-span-7">
            ...
            <h2 className="mt-4 font-heading text-3xl font-700 leading-[1.1] text-[#123B63] sm:text-4xl">
              Shared values make the family stronger
            </h2>
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-[#123B63]/70">
              MARS FLC partners with banking and non-banking financial
              institutions across its core legal, financial, recovery,
              verification, and administrative support services.
            </p>
          </div>
      ...
      <section className="py-20 md:py-24">
        <div className="container-custom mx-auto max-w-[1400px] px-4">
          <SectionHeader
            ...
            intro="Explore the services provided by Mars Financial & Legal Consultancy."
          />
